...
public final class Checker implements Visitor {
    ...
    private void registerProcFuncsIDs(ProcFuncs ast) {
    ...
    private void registerProcFuncID(Declaration procFunc) {
            ...
            if (!((vType instanceof ArrayTypeDenoter) || (vType instanceof ArrayTypeDenoterStatic))) //Proyecto 3 antes no reconocia el arreglo estatico como un arreglo
                ...
                if (!eType.equals(StdEnvironment.integerType))
                    reporter.reportError("Integer expression expected here", "",
                            ast.E.position);
                //Proyecto 3, agregado para soportar arrelo estatico
    ...
    private void establishStdEnvironment() {
        ...
        //Proyecto 3, modificar el ambiente estandar para añadir la función primitiva indexcheck
        StdEnvironment.indexcheck = declareStdProc("indexcheck",
                new MultipleFormalParameterSequence(
                        new VarFormalParameter(dummyI, StdEnvironment.integerType, dummyPos), //index
                        new MultipleFormalParameterSequence(
                                new VarFormalParameter(dummyI, StdEnvironment.integerType, dummyPos), //IL1
                                new SingleFormalParameterSequence(
                                        new VarFormalParameter(dummyI, StdEnvironment.integerType, dummyPos), //IL2
                                        dummyPos
                                ),
                                dummyPos
                        ),
